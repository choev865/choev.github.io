...
// What happens at the fornt end?
// filter button "Empowering"
// user presses filter button > "Empowering"
// see a list of songs associated with that filter > has the "Empowering" tag



// line30-39

// record.fields.Mood gives us a specific mood tags > "Empowering"
// document.body.createElement() >creates new html element
// html.Element.classList.add("cssClassName")
// logic to get airtable record to html element
// #1
// #2
// set html  content to airtable dataset
// append html element to html body

// How can we create a structure that allows for filter?
// Button "empowering"
// user presses it we can get that empowering is being pressed > script.js searc hfor "Empowering"

// structure to airtable record to html 
// each record has its own div
// <div class = "record" data-mood = "energetic" data-duration = "5min">
//   <img src = "url.png">
//   <span> data from airtable </span>
// </div>

// htmlElement.setAttribute("data-mood", record.fields.Mood);
